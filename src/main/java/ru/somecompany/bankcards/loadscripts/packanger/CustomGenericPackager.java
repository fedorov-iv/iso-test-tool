...
public class CustomGenericPackager 
    extends ISOBasePackager implements Configurable
{
   /* Values copied from ISOBasePackager
     ...
     */
    public CustomGenericPackager(String filename) throws ISOException
    {
        this();
     ...
     */
    public CustomGenericPackager(InputStream input) throws ISOException
    {
        this();
        readFile(input);
    }
            ...
            try
            {
                ...
                if (localName.equals("isofieldpackager"))
                {
                    ...
                    */
                    ...
                    if (p instanceof CustomGenericPackager)
                    {
                    	CustomGenericPackager gp = (CustomGenericPackager) p;
